...
from skrl.multi_agents.torch import MultiAgentMC
from skrl.resources.schedulers.torch import KLAdaptiveLR


# fmt: off
# [start-config-dict-torch]
HAPPO_MC_DEFAULT_CONFIG = {
...
class HAPPOMC(MultiAgentMC):
    def __init__(
        ...
        """Heterogeneous-Agent Proximal Policy Optimization (HAPPO) with MC (Multi-Critic)

        https://arxiv.org/abs/2103.01955
        
        Multi critic: https://github.com/InternRobotics/HoST/blob/70bb580949a336a920833700e4b5dc3bf7fe87ce/rsl_rl/rsl_rl/runners/on_policy_runner.py#L133
        ...
        """
        _cfg = copy.deepcopy(HAPPO_MC_DEFAULT_CONFIG)
